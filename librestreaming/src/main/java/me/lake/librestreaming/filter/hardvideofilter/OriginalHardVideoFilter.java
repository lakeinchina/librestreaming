...
public class OriginalHardVideoFilter extends BaseHardVideoFilter {
    ...
    protected int glPostionLoc;
    protected int glTextureCoordLoc;
    ...
    public void onInit(int VWidth, int VHeight) {
        ...
        glPostionLoc = GLES20.glGetAttribLocation(glProgram, "aPosition");
    ...
    public void onDraw(int cameraTexture, FloatBuffer shapeBuffer, FloatBuffer textrueBuffer) {
        ...
        GLES20.glEnableVertexAttribArray(glPostionLoc);
        GLES20.glEnableVertexAttribArray(glTextureCoordLoc);
        shapeBuffer.position(0);
        GLES20.glVertexAttribPointer(glPostionLoc, 2,
                GLES20.GL_FLOAT, false,
                2 * 4, shapeBuffer);
        textrueBuffer.position(0);
        GLES20.glVertexAttribPointer(glTextureCoordLoc, 2,
                GLES20.GL_FLOAT, false,
                2 * 4, textrueBuffer);
        ...
        GLES20.glFinish();
        GLES20.glDisableVertexAttribArray(glPostionLoc);
